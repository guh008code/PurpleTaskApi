...
namespace PurpleTask.Repositorios
{
    public class SetorRepositorio : ISetorRepositorio
    {
        ...
        public async Task<ResponseModel<Set>> BuscarPorId(int id, int? idEmpresa, int? idLocal, int? idCentroDeCusto, int idInstalacao)
        {
            ResponseModel<Set> resposta = new ResponseModel<Set>();
            try
            {
                if (!string.IsNullOrEmpty(id.ToString()) && !string.IsNullOrEmpty(idEmpresa.ToString()) && !string.IsNullOrEmpty(idLocal.ToString()) && !string.IsNullOrEmpty(idCentroDeCusto.ToString()) && !string.IsNullOrEmpty(idInstalacao.ToString()))
                {
                ...
                else if (!string.IsNullOrEmpty(id.ToString()) && !string.IsNullOrEmpty(idEmpresa.ToString()) && !string.IsNullOrEmpty(idLocal.ToString()) && string.IsNullOrEmpty(idCentroDeCusto.ToString()) && !string.IsNullOrEmpty(idInstalacao.ToString()))
                {
                    var usuarios = await _dbContext.Sets.FirstOrDefaultAsync(x => x.SetId == id
                                                                            && x.SetEpsId == idEmpresa
                                                                            && x.SetLocId == idLocal
